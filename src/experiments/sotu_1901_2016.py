...
def main():
    ...
    train = Corpus(input_file=data_dir + "sotu_train_1901_2016.txt", vocab_file=data_dir + "sotu_dpp_vocab_1901_2016.txt")
    test = Corpus(input_file=data_dir + "sotu_test_1901_2016.txt",
              vocab_file=data_dir + "sotu_dpp_vocab_1901_2016.txt", author2id=train.author2id)
    ...
    # save model output
    results_dir = os.path.join(path_to_current_file, "../../results/sotu_1901_2016/")
